...
/**
 * <p>Clase Java para upsertPliego complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertPliego">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataPliego" type="{http://webservice.presupuesto/}pliego" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertPliego", propOrder = {
    "dataPliego",
    "time",
    "ejec",
    "tabla",
...
public class UpsertPliego {

    protected List<Pliego> dataPliego;
    protected long time;
    ...
    /**
     * Gets the value of the dataPliego property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataPliego property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataPliego().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Pliego> getDataPliego() {
        if (dataPliego == null) {
            dataPliego = new ArrayList<Pliego>();
        }
        return this.dataPliego;
    }
