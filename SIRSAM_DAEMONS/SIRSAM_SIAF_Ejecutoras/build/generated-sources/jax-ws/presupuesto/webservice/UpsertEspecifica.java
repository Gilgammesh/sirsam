...
/**
 * <p>Clase Java para upsertEspecifica complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertEspecifica">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataEspecifica" type="{http://webservice.presupuesto/}especifica" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertEspecifica", propOrder = {
    "dataEspecifica",
    "time",
    "ejec",
    "tabla",
...
public class UpsertEspecifica {

    protected List<Especifica> dataEspecifica;
    protected long time;
    ...
    /**
     * Gets the value of the dataEspecifica property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataEspecifica property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataEspecifica().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Especifica> getDataEspecifica() {
        if (dataEspecifica == null) {
            dataEspecifica = new ArrayList<Especifica>();
        }
        return this.dataEspecifica;
    }
