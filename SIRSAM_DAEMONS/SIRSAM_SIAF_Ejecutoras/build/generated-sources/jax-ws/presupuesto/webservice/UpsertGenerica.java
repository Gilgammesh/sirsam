...
/**
 * <p>Clase Java para upsertGenerica complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertGenerica">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataGenerica" type="{http://webservice.presupuesto/}generica" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertGenerica", propOrder = {
    "dataGenerica",
    "time",
    "ejec",
    "tabla",
...
public class UpsertGenerica {

    protected List<Generica> dataGenerica;
    protected long time;
    ...
    /**
     * Gets the value of the dataGenerica property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataGenerica property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataGenerica().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Generica> getDataGenerica() {
        if (dataGenerica == null) {
            dataGenerica = new ArrayList<Generica>();
        }
        return this.dataGenerica;
    }
