...
/**
 * <p>Clase Java para upsertCertificado complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertCertificado">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataCertificado" type="{http://webservice.presupuesto/}certificado" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertCertificado", propOrder = {
    "dataCertificado",
    "time",
    "ejec",
    "tabla",
...
public class UpsertCertificado {

    protected List<Certificado> dataCertificado;
    protected long time;
    ...
    /**
     * Gets the value of the dataCertificado property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataCertificado property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataCertificado().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Certificado> getDataCertificado() {
        if (dataCertificado == null) {
            dataCertificado = new ArrayList<Certificado>();
        }
