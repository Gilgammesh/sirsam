...
/**
 * <p>Clase Java para upsertGasto complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertGasto">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataGasto" type="{http://webservice.presupuesto/}gasto" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertGasto", propOrder = {
    "dataGasto",
    "time",
    "ejec",
    "tabla",
...
public class UpsertGasto {

    protected List<Gasto> dataGasto;
    protected long time;
    ...
    /**
     * Gets the value of the dataGasto property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataGasto property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataGasto().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Gasto> getDataGasto() {
        if (dataGasto == null) {
            dataGasto = new ArrayList<Gasto>();
        }
