...
/**
 * <p>Clase Java para upsertFinalidad complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertFinalidad">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataFinalidad" type="{http://webservice.presupuesto/}finalidad" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertFinalidad", propOrder = {
    "dataFinalidad",
    "time",
    "ejec",
    "tabla",
...
public class UpsertFinalidad {

    protected List<Finalidad> dataFinalidad;
    protected long time;
    ...
    /**
     * Gets the value of the dataFinalidad property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataFinalidad property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataFinalidad().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Finalidad> getDataFinalidad() {
        if (dataFinalidad == null) {
            dataFinalidad = new ArrayList<Finalidad>();
        }
        return this.dataFinalidad;
    }
