...
/**
 * <p>Clase Java para upsertPersona complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertPersona">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataPersona" type="{http://webservice.presupuesto/}persona" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertPersona", propOrder = {
    "dataPersona",
    "time",
    "ejec",
    "tabla",
...
public class UpsertPersona {

    protected List<Persona> dataPersona;
    protected long time;
    ...
    /**
     * Gets the value of the dataPersona property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataPersona property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataPersona().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Persona> getDataPersona() {
        if (dataPersona == null) {
            dataPersona = new ArrayList<Persona>();
        }
