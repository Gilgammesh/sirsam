...
/**
 * <p>Clase Java para upsertBanco complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertBanco">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataBanco" type="{http://webservice.presupuesto/}banco" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertBanco", propOrder = {
    "dataBanco",
    "time",
    "ejec",
    "tabla",
...
public class UpsertBanco {

    protected List<Banco> dataBanco;
    protected long time;
    ...
    /**
     * Gets the value of the dataBanco property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataBanco property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataBanco().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Banco> getDataBanco() {
        if (dataBanco == null) {
            dataBanco = new ArrayList<Banco>();
        }
