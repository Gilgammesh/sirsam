...
/**
 * <p>Clase Java para upsertProvincia complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertProvincia">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataProvincia" type="{http://webservice.presupuesto/}provincia" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertProvincia", propOrder = {
    "dataProvincia",
    "time",
    "ejec",
    "tabla",
...
public class UpsertProvincia {

    protected List<Provincia> dataProvincia;
    protected long time;
    ...
    /**
     * Gets the value of the dataProvincia property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataProvincia property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataProvincia().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Provincia> getDataProvincia() {
        if (dataProvincia == null) {
            dataProvincia = new ArrayList<Provincia>();
        }
        return this.dataProvincia;
    }
