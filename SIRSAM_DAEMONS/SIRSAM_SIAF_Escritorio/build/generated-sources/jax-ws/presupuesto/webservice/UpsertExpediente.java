...
/**
 * <p>Clase Java para upsertExpediente complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertExpediente">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataExpediente" type="{http://webservice.presupuesto/}expediente" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertExpediente", propOrder = {
    "dataExpediente",
    "time",
    "ejec",
    "tabla",
...
public class UpsertExpediente {

    protected List<Expediente> dataExpediente;
    protected long time;
    ...
    /**
     * Gets the value of the dataExpediente property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataExpediente property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataExpediente().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Expediente> getDataExpediente() {
        if (dataExpediente == null) {
            dataExpediente = new ArrayList<Expediente>();
        }
