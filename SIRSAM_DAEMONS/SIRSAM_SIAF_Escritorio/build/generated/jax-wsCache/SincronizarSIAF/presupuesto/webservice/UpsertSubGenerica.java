...
/**
 * <p>Clase Java para upsertSubGenerica complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertSubGenerica">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataSubGenerica" type="{http://webservice.presupuesto/}subGenerica" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertSubGenerica", propOrder = {
    "dataSubGenerica",
    "time",
    "ejec",
    "tabla",
...
public class UpsertSubGenerica {

    protected List<SubGenerica> dataSubGenerica;
    protected long time;
    ...
    /**
     * Gets the value of the dataSubGenerica property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataSubGenerica property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataSubGenerica().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SubGenerica> getDataSubGenerica() {
        if (dataSubGenerica == null) {
            dataSubGenerica = new ArrayList<SubGenerica>();
        }
        return this.dataSubGenerica;
    }
