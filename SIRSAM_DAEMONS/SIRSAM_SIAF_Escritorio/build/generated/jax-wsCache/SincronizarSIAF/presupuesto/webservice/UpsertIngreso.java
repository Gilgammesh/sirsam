...
/**
 * <p>Clase Java para upsertIngreso complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertIngreso">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataIngreso" type="{http://webservice.presupuesto/}ingreso" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertIngreso", propOrder = {
    "dataIngreso",
    "time",
    "ejec",
    "tabla",
...
public class UpsertIngreso {

    protected List<Ingreso> dataIngreso;
    protected long time;
    ...
    /**
     * Gets the value of the dataIngreso property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataIngreso property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataIngreso().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Ingreso> getDataIngreso() {
        if (dataIngreso == null) {
            dataIngreso = new ArrayList<Ingreso>();
        }
