...
/**
 * <p>Clase Java para upsertFase complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertFase">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataFase" type="{http://webservice.presupuesto/}fase" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertFase", propOrder = {
    "dataFase",
    "time",
    "ejec",
    "tabla",
...
public class UpsertFase {

    protected List<Fase> dataFase;
    protected long time;
    ...
    /**
     * Gets the value of the dataFase property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataFase property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataFase().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Fase> getDataFase() {
        if (dataFase == null) {
            dataFase = new ArrayList<Fase>();
        }
