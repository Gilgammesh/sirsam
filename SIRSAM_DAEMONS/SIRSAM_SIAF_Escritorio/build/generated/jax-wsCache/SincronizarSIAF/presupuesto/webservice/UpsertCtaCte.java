...
/**
 * <p>Clase Java para upsertCtaCte complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertCtaCte">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataCtaCte" type="{http://webservice.presupuesto/}ctaCte" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertCtaCte", propOrder = {
    "dataCtaCte",
    "time",
    "ejec",
    "tabla",
...
public class UpsertCtaCte {

    protected List<CtaCte> dataCtaCte;
    protected long time;
    ...
    /**
     * Gets the value of the dataCtaCte property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataCtaCte property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataCtaCte().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CtaCte> getDataCtaCte() {
        if (dataCtaCte == null) {
            dataCtaCte = new ArrayList<CtaCte>();
        }
        return this.dataCtaCte;
    }
