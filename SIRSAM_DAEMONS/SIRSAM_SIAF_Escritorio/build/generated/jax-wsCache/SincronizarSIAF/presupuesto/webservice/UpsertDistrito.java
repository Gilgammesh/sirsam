...
/**
 * <p>Clase Java para upsertDistrito complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertDistrito">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataDistrito" type="{http://webservice.presupuesto/}distrito" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertDistrito", propOrder = {
    "dataDistrito",
    "time",
    "ejec",
    "tabla",
...
public class UpsertDistrito {

    protected List<Distrito> dataDistrito;
    protected long time;
    ...
    /**
     * Gets the value of the dataDistrito property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataDistrito property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataDistrito().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Distrito> getDataDistrito() {
        if (dataDistrito == null) {
            dataDistrito = new ArrayList<Distrito>();
        }
        return this.dataDistrito;
    }
