...
/**
 * <p>Clase Java para upsertDepartamento complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertDepartamento">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataDepartamento" type="{http://webservice.presupuesto/}departamento" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertDepartamento", propOrder = {
    "dataDepartamento",
    "time",
    "ejec",
    "tabla",
...
public class UpsertDepartamento {

    protected List<Departamento> dataDepartamento;
    protected long time;
    ...
    /**
     * Gets the value of the dataDepartamento property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataDepartamento property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataDepartamento().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Departamento> getDataDepartamento() {
        if (dataDepartamento == null) {
            dataDepartamento = new ArrayList<Departamento>();
        }
        return this.dataDepartamento;
    }
