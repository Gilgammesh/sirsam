...
/**
 * <p>Clase Java para upsertFuenteFinanc complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="upsertFuenteFinanc">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="dataFuenteFinanc" type="{http://webservice.presupuesto/}fuenteFinanc" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "upsertFuenteFinanc", propOrder = {
    "dataFuenteFinanc",
    "time",
    "ejec",
    "tabla",
...
public class UpsertFuenteFinanc {

    protected List<FuenteFinanc> dataFuenteFinanc;
    protected long time;
    ...
    /**
     * Gets the value of the dataFuenteFinanc property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dataFuenteFinanc property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataFuenteFinanc().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FuenteFinanc> getDataFuenteFinanc() {
        if (dataFuenteFinanc == null) {
            dataFuenteFinanc = new ArrayList<FuenteFinanc>();
        }
        return this.dataFuenteFinanc;
    }
