...
public class CaptchaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Color textColor = new Color(255, 93, 0); //color de la letra
            Color circleColor = new Color(255, 255, 255); //color de los circulos
            Font textFont = new Font("Arial", Font.BOLD, 34);
            int charsToPrint = 6;
            int width = request.getParameter("width") != null ? Integer.parseInt(request.getParameter("width")) : 390;
            ...
            //Draw an oval
            g.setColor(new Color(254, 235, 212)); //color fondo
